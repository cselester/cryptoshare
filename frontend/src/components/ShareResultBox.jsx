import { formatExpiryTimestamp } from "../utils/dateTime";

function ShareResultBox({ link, code, expiresAt }) {
  ...
  return (
    <div className="result-box">
      ...
      <p className="note">
        This secret will self-destruct after viewing or when it expires.
      </p>
